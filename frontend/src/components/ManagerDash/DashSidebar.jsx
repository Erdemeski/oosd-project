...
import { HiArrowSmLeft, HiArrowSmRight, HiChartPie, HiDocumentText, HiOutlineUserGroup, HiUser, HiUsers, HiSpeakerphone } from 'react-icons/hi'
                ...
                <Sidebar.Items>
                    ...
                    <Sidebar.ItemGroup className='flex flex-col gap-1'>
                        {currentUser && currentUser.isManager && (
                            <Link to='/manager-dashboard?tab=dashboard'>
                                <Sidebar.Item active={tab === 'dashboard' || !tab} icon={HiChartPie} as='div' label="Manager" labelColor="success">Dashboard</Sidebar.Item>
                            </Link>
                        )}
                        {currentUser && currentUser.isManager && (
