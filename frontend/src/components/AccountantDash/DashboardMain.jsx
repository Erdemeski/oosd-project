    ...
    <div className='relative isolate flex-1 p-4 md:p-7'>
      ...
      <div className='flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4'>
        <div>
          ...
          <p className='text-gray-600 dark:text-gray-400 mt-1'>
            Welcome to your accounting dashboard. Manage financial data and reports here.
          </p>
        </div>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
        <Card className='p-6'>
          ...
          <p className='text-gray-600 dark:text-gray-400'>Your financial overview content will go here.</p>
        </Card>
        ...
        <Card className='p-6'>
          <h3 className='text-lg font-semibold text-gray-800 dark:text-white mb-4'>Transactions</h3>
          <p className='text-gray-600 dark:text-gray-400'>Your transactions content will go here.</p>
        </Card>
      </div>
    </div>
  );
